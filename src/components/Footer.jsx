            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#" className="hover:text-[#a1784c] transition">Stats</a></li>
                  <li><a href="#" className="hover:text-[#a1784c] transition">Services</a></li>
                  <li><a href="#" className="hover:text-[#a1784c] transition">Reviews</a></li>
